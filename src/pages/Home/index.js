    ...
    <div className="home">
        ...
        <div className="btn_container">
          ...
          <div className="signup_btn_container">
            <button className="signup_btn">
              <div className="signup_btn_content">Sign up</div>
            </button>
          </div>
      ...
      <div className="main_container">
        ...
        <div className="home_steps_title_container">
          <div className="step_title_container">
        ...
        <div className="home_steps_subtitle_container">
          <div className="step_subtitle_content">
            <p>
              Start new game with the option to add your issues right off the
              bat.
            </p>
          </div>
          <div className="step_subtitle_content">
          ...
          <div className="step_subtitle_content">
            <p>
              Enjoy every aspect of our online scrum planning poker – and have
              fun while being productive!
            </p>
          </div>
        </div>
      </div>
